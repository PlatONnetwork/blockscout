defmodule Indexer.Fetcher.PlatonAppchain.Contracts.L2StakeHandler do
  ...
  def getValidatorsWithAddr(validator_addresses, block_number) do
    ...
    result = get_validators_with_addr(validator_addresses) |> Ethers.call(to: l2StakeHandlerContract(), block: block_number, rpc_opts: rpc_opts())
  ...
  def getValidator(validator_hex, block_number) do
    ...
    result = get_validators_with_addr([validator_hex]) |> Ethers.call(to: l2StakeHandlerContract(), block: block_number, rpc_opts: rpc_opts())
    {:ok, validators} = result
