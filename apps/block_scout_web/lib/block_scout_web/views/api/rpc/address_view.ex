defmodule BlockScoutWeb.API.RPC.AddressView do
  ...
  defp prepare_transaction(transaction) do
    %{
      ...
      "timeStamp" => "#{DateTime.to_unix(transaction.block_timestamp, :millisecond)}",
      "hash" => "#{transaction.hash}",
      "nonce" => "#{transaction.nonce}",
  ...
  defp prepare_internal_transaction(internal_transaction) do
    %{
      ...
      "timeStamp" => "#{DateTime.to_unix(internal_transaction.block_timestamp, :millisecond)}",
  ...
  defp prepare_common_token_transfer(token_transfer) do
    %{
      ...
      "timeStamp" => to_string(DateTime.to_unix(token_transfer.block_timestamp, :millisecond)),
